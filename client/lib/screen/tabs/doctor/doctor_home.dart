...
class _DoctorHomeState extends State<DoctorHome> {
  ...
  Future<Map<String, dynamic>> fetchDoctorDashboard() async {
    ...
    const String apiUrl = "http://localhost:5000/api/doctors/dashboard";
  ...
  Future<Map<String, dynamic>> _fetchMessageStats() async {
    ...
    final response = await http.get(
      Uri.parse('http://localhost:5000/api/messages/stats'),
      headers: {
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json',
      },
  ...
  Future<Map<String, dynamic>> _fetchEventStats() async {
    ...
    final response = await http.get(
      Uri.parse('http://localhost:5000/api/events/stats-2'),
      headers: {
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json',
      },
  ...
  Future<List<dynamic>> _fetchAppointmentStats() async {
    ...
    final response = await http.get(
      Uri.parse('http://localhost:5000/api/appointments/stats'),
      headers: {
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json',
      },
