...
class _DoctorAvailabilityScreenState extends State<DoctorAvailabilityScreen> {
  ...
  Future<void> _fetchAvailabilities() async {
    ...
    try {
      ...
      final url = Uri.parse(
        'http://localhost:5000/api/doctors/availability?date=$formattedDate',
      );
  ...
  Future<void> _createAvailability(String start, String end) async {
    ...
    try {
      ...
      final formattedDate = DateFormat('yyyy-MM-dd').format(selectedDate!);
      final url = Uri.parse('http://localhost:5000/api/doctors/availability');
  ...
  Future<void> _deleteAvailability(String id) async {
    try {
      ...
      print(id);
      final url = Uri.parse(
        'http://localhost:5000/api/doctors/availability/$id',
      );
  ...
  Future<void> _setUnavailable(String id) async {
    try {
      ...
      final url = Uri.parse(
        'http://localhost:5000/api/doctors/availability/$id/unavailable',
      );
